      ...
      <div class="space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <select :value="selectedModel" @change="emit('update:selectedModel', $event.target.value)" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white">
          ...
          <div>
            ...
            <select :value="size" @change="emit('update:size', $event.target.value)" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white">
