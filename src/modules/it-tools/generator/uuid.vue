<template>
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    ...
    <div class="flex gap-3 mb-4">
      <button @click="generate" class="flex-1 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all shadow-lg shadow-cyan-500/25 font-medium flex items-center justify-center gap-2">
