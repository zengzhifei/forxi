  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    ...
    <div class="space-y-4">
      ...
      <div class="flex flex-wrap gap-2">
        <button @click="encode" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">编码</button>
        <button @click="decode" class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors">解码</button>
