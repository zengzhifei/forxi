...
const routes = [
  ...
  },
  {
    ...
    component: AuthView,
    meta: {
      title: '福兮 Forxi - 登录 / 注册',
      description: '登录或注册 福兮 Forxi 账号，享受文件预览、图片处理、AI 创作等在线工具服务。',
      keywords: '福兮,Forxi,登录,注册,账号'
    }
  },
  {
    path: '/profile',
    ...
    meta: {
      title: '福兮 Forxi - 个人中心',
      description: '管理您的 福兮 Forxi 账户信息、修改密码、绑定第三方账号。',
  ...
  },
  {
    ...
    meta: {
      title: '福兮 Forxi - 找回密码',
      description: '通过绑定邮箱找回并重置您的 福兮 Forxi 账户密码。',
  ...
  },
  {
    ...
    meta: {
      title: '福兮 Forxi - 服务条款',
      description: '福兮 Forxi 服务条款，规定了用户使用本服务的权利和义务。',
      keywords: '福兮,Forxi,服务条款,用户协议'
    }
  },
  {
    path: '/hub/',
    ...
    meta: {
      ...
      keywords: '福兮,应用,工具箱,文件预览,图片处理,OCR'
    }
  },
  {
    ...
    meta: {
      title: '福兮 Forxi - 应用 - 文件预览',
      description: '免费在线预览 PDF、Word、Excel、PPT、图片、视频等多种文件格式，无需下载，打开即览。',
      keywords: '福兮,在线文件预览,PDF预览,Word预览,Excel预览,PPT预览,图片预览,免费文件预览'
    }
  },
  {
    ...
    meta: {
      title: '福兮 Forxi - 应用 - 图片处理',
      description: '免费在线图片处理，支持压缩、裁剪、旋转、加水印、调滤镜、格式转换，纯本地处理保护隐私。',
      keywords: '福兮,在线图片处理,图片压缩,图片裁剪,图片旋转,图片水印,图片格式转换,免费图片编辑'
    }
  },
  {
    path: '/hub/ocr',
    ...
    component: OcrView,
    meta: {
      title: '福兮 Forxi - 应用 - 图片OCR',
      description: '免费在线图片文字识别工具，支持中文、英文等多种语言识别，纯前端处理，保护隐私。',
      keywords: '福兮,图片OCR,文字识别,图片转文字,在线OCR,中文识别'
    }
  },
  {
    path: '/hub/it-tools',
    ...
    meta: {
      title: '福兮 Forxi - 应用 - IT 工具箱',
      description: '开发者常用工具集合，包含 Base64 编解码、JSON 格式化、UUID 生成、颜色转换、正则测试、时间戳转换等实用工具。',
      keywords: '福兮,IT工具箱,开发工具,Base64编码,JSON格式化,UUID生成,颜色转换,正则表达式,时间戳转换,URL编码,MD5'
    }
  },
  {
    ...
    meta: {
      title: '福兮 Forxi - 应用 - 流程工厂',
      description: '免费在线流程图制作工具，支持节点添加、连接、拖拽、删除、属性编辑，可导出 PNG、JPEG 图片格式。',
      keywords: '福兮,流程图,流程工厂,在线流程图,flowchart,流程制作'
    }
  },
  {
    ...
    meta: {
      title: '福兮 Forxi - 应用 - 文件转换',
      description: '免费在线文件转换工具，支持图片、文本、Word、表格等多种格式转换为 PDF。',
      keywords: '福兮,文件转换,PDF转换,图片转PDF,文本转PDF,Word转PDF,表格转PDF'
    }
  },
  {
    path: '/ai/',
    ...
    meta: {
      ...
      keywords: '福兮,AI,文生图,图生图,AI绘画,AI对话,AI创作,免费AI工具'
    }
  },
  {
    path: '/ai/chat',
    ...
    component: ChatView,
    meta: {
      title: '福兮 Forxi - AI - 聊一聊',
      description: '与 AI 智能对话，解答问题、编写代码、创作文案。',
      keywords: '福兮,AI对话,AI聊天,智能助手'
    }
  },
  {
    path: '/ai/text2image',
    ...
    meta: {
      title: '福兮 Forxi - AI - 文生图',
      description: '输入文字描述，AI 为你生成精美图片。',
      keywords: '福兮,文生图,AI绘画,AI生成图片'
    }
  },
  {
    path: '/ai/image2image',
    ...
    meta: {
      title: '福兮 Forxi - AI - 图生图',
      description: '上传图片并描述变化，AI 帮你改造图片。',
      keywords: '福兮,图生图,AI改图,AI图片处理'
    }
  },
  {
    path: '/idea/',
  ...
  },
  {
    ...
    meta: {
      title: '福兮 Forxi - 创意 - 文章',
      description: '技术文章、随笔杂谈、经验总结，涵盖前端开发、后端技术、DevOps 等领域。',
      keywords: '福兮,技术文章,随笔,经验总结,前端,后端,DevOps'
    }
  },
  {
    ...
    meta: {
      title: '福兮 Forxi - 创意 - 冷知识',
      description: '探索有趣的小知识，发现世界的奇妙之处。',
      keywords: '福兮,冷知识,趣味知识,有趣事实'
    }
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      keywords: '福兮,探索,JetBrains,开发者资源'
    }
  },
  {
    path: '/explore/jetbra',
    ...
    meta: {
      title: '福兮 Forxi - 探索 - JetBrains 激活',
      description: 'JetBrains 系列 IDE 激活服务，支持 IntelliJ IDEA、PyCharm、WebStorm、GoLand 等。',
      keywords: '福兮,JetBrains激活,IntelliJ IDEA,PyCharm,WebStorm,GoLand,Rider,CLion,IDE激活'
    }
  },
  {
  ...
  },
  {
    ...
    component: MbtiView,
    meta: {
      title: '福兮 Forxi - 探索 - MBTI 人格测试',
      description: '免费在线 MBTI 人格类型测试，精选题目带你发现真实的自己，探索你的性格密码。',
      keywords: '福兮,MBTI，人格测试，性格测试，16 型人格，职业测试'
    }
  },
  {
    path: '/hub/calculator',
    ...
    meta: {
      title: '福兮 Forxi - 应用 - 超级计算器',
      description: '免费在线超级计算器，支持数学计算、科学计算、金融计算、进制转换、字节换算、单位换算等多种计算功能。',
      keywords: '福兮,计算器，在线计算器，科学计算器，复利计算器，进制转换，单位换算'
    }
  },
  {
    path: '/hub/ip-query',
  ...
  },
  {
    ...
    meta: {
      title: '福兮 Forxi - 页面不存在',
      description: '您访问的页面不存在，请返回首页继续探索 福兮 Forxi 在线工具。',
      keywords: '福兮,Forxi,404'
    }
  }
]
...
router.beforeEach(async (to) => {
  ...
  updateOgTag('og:title', to.meta.title || '福兮 Forxi - 免费内容平台')
